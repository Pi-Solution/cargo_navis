...
function show_form_izlazne_fakture(update_or_delete, index){
    ...
    if (update_or_delete == 2) {
        ...
        document.getElementById("fif-cim").checked = return_bool(s_data.izlazne_fakture[index].cim)
        document.getElementById("fif-cmr").checked = return_bool(s_data.izlazne_fakture[index].cmr)
        document.getElementById("fif-zut").checked = return_bool(s_data.izlazne_fakture[index].zut)
        document.getElementById("fif-cd").checked = return_bool(s_data.izlazne_fakture[index].cd)

        console.log('form' + s_data.izlazne_fakture[index].cd)
    }
}
function return_bool(data){
    if(data == 0){
        return false;
    }else{
        return true;
